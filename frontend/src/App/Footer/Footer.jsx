      ...
      <Container>
        <Toolbar className={classes.footerToolbar}>
          <div>
            ...
            <div>
              Instituto público (08076391) del distrito de Les Corts, con oferta
              de ESO, Bachillerato, CF de Informática, y de Imagen y sonido, y
          ...
          <div>
            ...
            <a href="https://afapedralbes.wordpress.com/" className={classes.a}>
              Web AFA
            </a>
          </div>
          <div>
